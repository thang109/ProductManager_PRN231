...
namespace BookShopBusiness.Migrations
{
    ...
    [Migration("20241107144845_UpdateFormatPrice")]
    partial class UpdateFormatPrice
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BookShopBusiness.Shippings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ShippingId = 1,
                            BookId = 1,
                            DateBooking = new DateTime(2024, 11, 7, 21, 48, 45, 567, DateTimeKind.Local).AddTicks(1289),
                            DateShip = new DateTime(2024, 11, 9, 21, 48, 45, 567, DateTimeKind.Local).AddTicks(1305),
                        ...
                        new
                        {
                            ShippingId = 2,
                            BookId = 2,
                            DateBooking = new DateTime(2024, 11, 7, 21, 48, 45, 567, DateTimeKind.Local).AddTicks(1318),
                            DateShip = new DateTime(2024, 11, 10, 21, 48, 45, 567, DateTimeKind.Local).AddTicks(1319),
